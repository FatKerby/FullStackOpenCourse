...
describe('total likes', () => {
  ...
  test('Total likes of empty blogs', () => {
...
describe('favorite blog', () => {
    ...
    test('Favorite blog out of multiple blogs', () => {
        assert.deepStrictEqual(listHelper.favoriteBlog(blogs), blogs[2])
    })

    test('Favorite blog of empty blogs', () => {
        assert.deepStrictEqual(listHelper.favoriteBlog(emptyBlog), [])
    })
})